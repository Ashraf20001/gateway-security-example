...
public class NotEqualMongoFilterGateway implements IGatewayMasterMongoFilter {
	...
	public Document getFilterPredicate(FilterOrSortingVo filterVo) throws ApplicationException {
		...
		return new Document(filterVo.getColumnName(), new Document(ApplicationConstants.NOT_IN_MONGO, obj));
	}
