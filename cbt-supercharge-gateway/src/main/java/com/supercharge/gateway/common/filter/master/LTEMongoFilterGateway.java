...
public class LTEMongoFilterGateway implements IGatewayMasterMongoFilter {
	...
	public Document getFilterPredicate(FilterOrSortingVo filterVo) throws ApplicationException {
		...
		return new Document(filterVo.getColumnName(), new Document(ApplicationConstants.LESSERTHAN_EQUALSTO, obj));
	}
