...
public class GTMongoFilterGateway implements IGatewayMasterMongoFilter {
	...
	public Document getFilterPredicate(FilterOrSortingVo filterVo) throws ApplicationException {
		...
		return new Document(filterVo.getColumnName(), new Document(ApplicationConstants.GREATERTHAN, obj));
	}
