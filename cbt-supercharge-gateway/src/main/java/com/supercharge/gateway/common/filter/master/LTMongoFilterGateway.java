...
public class LTMongoFilterGateway implements IGatewayMasterMongoFilter {
	...
	public Document getFilterPredicate(FilterOrSortingVo filterVo) throws ApplicationException {
		...
		return new Document(filterVo.getColumnName(), new Document(ApplicationConstants.LESSERTHAN, obj));
	}
